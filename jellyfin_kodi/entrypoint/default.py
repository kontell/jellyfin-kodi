...
def listing():
    ...
    directory(translate(33273), "plugin://plugin.video.jellyfin/?mode=livetv_timers", True)
    directory(translate(33275), "plugin://plugin.video.jellyfin/?mode=livetv_series_timers", True)
...
def livetv_series_timers(jellyfin_client):
    ...
    for timer in timers:
        ...
        li.addContextMenuItems([
            (
                translate(33276),  # "Cancel Series Timer"
